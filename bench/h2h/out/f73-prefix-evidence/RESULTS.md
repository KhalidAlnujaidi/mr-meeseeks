...
|------|--------------------|---------------------|
| T1 create hello.txt w/ ATOM | no-payload (3 nudges) | harness-error |
...
|--------|------|--------|
| completions | 14 | 14 |
| prompt_tokens | 858 | 22447 |
| completion_tokens | 141 | 2048 |
| avg_latency_ms | 6120 | 137683 |
| errors | 7 | 6 |
| streams | 14 | 0 |
...
- line counts by type: {"report": 8, "nudge": 10, "verify": 1}
